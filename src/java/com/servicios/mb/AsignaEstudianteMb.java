 ...
 * @author jespinoza
 */
@ManagedBean(name = "asignaEstudianteMB")
@ViewScoped

/*
    CLASE JAVA MANAGED BEANS DE ASIGNA ESTUDIANTE
*/

public class AsignaEstudianteMb implements Serializable{
    ...
    public void init()
    {
        ...
        //Obtiene Lista de Cursos Asignados al Estudiante.-
        detperiodoList     =   servicioAplicacion.consultaPeriodoCursoEstudiante(Long.valueOf("0"), Long.valueOf("0"), Long.valueOf("0"), Long.valueOf("0"), "A");
    ...
    public void onCursoChange() 
    {
        ...
        {
            System.out.println("Error en Metodo onCursoChange AsignaEstudianteMB: "+ex.getMessage());
        }      
    }
    ...
    */
    public void actualizar(RowEditEvent event) {
        try {
            ...
            servicioAplicacion.actualizaCursoAsignadoEstudiante(cursoAsignado);
    ...
    */
    public void ingresaCursoAsignado()
    {
        ...
        if( (periodo_cod   == null) || (periodo_cod  == 0)   || 
            ...
            (estudiante_cod  == null)  || (estudiante_cod == 0)
          )
          {
          ...
          else
          {
                ...
                if (cantidad == 0)
                {
                    ...
                    guardaCursoEstudiante( periodo_cod , curso_cod, paralelo_cod, Estado);
                    reestableceCursoAsignado();
                }
                else
                {
                    context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_WARN,"El estudiante ya se encuentra asignado en un curso.", "" ) );
                }  
          }
    }
    ...
    public void buscaCursoAsignado() 
    {
        ...
        detperiodoList      = servicioAplicacion.consultaPeriodoCursoEstudiante(periodo_cod, Long.valueOf("0"), Long.valueOf("0"), estudiante_cod, "A");
    ...
    {
        //Obtiene Detalle de cursos asignados al Estudiante.-
        ...
        detperiodoList      = servicioAplicacion.consultaPeriodoCursoEstudiante(periodo_cod, curso_cod, paralelo_cod, Long.valueOf("0"), "A");
        
    }
    
       public String estudiante ()  throws JRException, IOException
    {
      estudianteList=servicioAplicacion.obtenerEstudiante();
     
     

 for(TblEstudiante p : estudianteList)
 {
     String list_ident= p.getEstudianteIdent().toString();
    
     
     if(list_ident.equals(cedula))
     {
         estid=p.getEstudianteId().toString();
       nombres=p.getEstudianteNom()+ " " +p.getEstudianteApe();
 ...
 return nombres;
      //estudianteIdent
          ...
          public String estudianteid ()  throws JRException, IOException
    {
      estudianteList=servicioAplicacion.obtenerEstudiante();
 ...
 estudiante_cod=Long. parseLong(estid);
 return estid;
      //estudianteIdent
      }
    ...
    {   
     ...
     periodo_cod  =   Long.valueOf("0");
        ...
        detperiodoList      = servicioAplicacion.consultaPeriodoCursoEstudiante(periodo_cod, curso_cod, paralelo_cod, Long.valueOf("0"), "A");
     // url = generaPDF("rpt_EstudiantexCurso.jasper",detperiodoList);
   ...
   /*
        METODO PARA GUARDAR CURSO ASIGNADO AL ESTUDIANTE.-
    */
    public void guardaCursoEstudiante( Long periodo_cod1 , Long curso_cod1 , Long paralelo_cod1 , String estado)
    {
        FacesContext context = FacesContext.getCurrentInstance();
        ...
        System.out.println("guardaCursoDocente estudiante_cod: "+estudiante_cod+
        ...
        if ( curso_paraleloId  == null || curso_paraleloId == 0 ){
            ...
            estudiante.setEstudianteId(estudiante_cod);
            ...
            estudianteCurso.setEstudiantecursoSts(estado);

            servicioAplicacion.ingresaEstudianteCurso(estudianteCurso);
            
            context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO,"Estudiante asignado al curso con éxito.", "" ) );
   ...
   public String getcedula(){
    ...
    public Long getEstudiante_cod() {
        return estudiante_cod;
    }

    public void setEstudiante_cod(Long estudiante_cod) {
