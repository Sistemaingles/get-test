 ...
 * @author mespinoza
 */
@ManagedBean(name = "cursoEstudianteMB")
@RequestScoped
...
public class cursosEstudianteMB implements Serializable  {
    ...
    public List<CursoAsignadoList> getDetperiodoList() {
        detperiodoList     =  servicioAplicacion.consultaPeriodoCursoEstudiante(Long.valueOf("0"), Long.valueOf("0"), Long.valueOf("0"), Long.valueOf("0"), "");
