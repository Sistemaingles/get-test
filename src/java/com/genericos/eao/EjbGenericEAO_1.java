...
public abstract class EjbGenericEAO_1 <T extends BeanDominio, ID extends Serializable> 
extends AGenericEAO<T, ID> implements IEjbGenericEAO<T, ID>
{
        //@PersistenceContext(unitName="projectOra",type=PersistenceContextType.TRANSACTION)
	protected EntityManager administradorEntidadOra;
        
        
	public EjbGenericEAO_1(Class<? extends T> entityBeanType) {
	...
	{
		return administradorEntidadOra;
	}
