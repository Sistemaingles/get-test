...
public abstract class AGenericEAO_1<T extends BeanDominio, ID extends Serializable> implements IGenericEAO<T,ID>
{
...
//	protected abstract Logger getLogger (); 
	...
	public AGenericEAO_1(Class<? extends T> entityBeanType) {
